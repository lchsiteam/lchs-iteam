<template>
  <div id="sidebar">
    ...
    <ul class="sidebar-list">
      <li :class="{ selected: currentRouteName == 'Home' } " @click="goToPage('Home')">Home</li>
      ...
      <li :class="{ selected: currentRouteName == 'Subdomains' }" @click="goToPage('Subdomains')">Subdomains</li>
    </ul>
  </div>
</template>
